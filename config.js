...
module.exports = {
    "registercommands" : false,
     "token": "MTEwNjUxNjA1NjU0MzA3NjQxMw.GtolSF.7EvAeABxyRYXYpVKGWIJSx3olYfeOScppTCR80",
...
defaultleavemessage: "{user} Left, Invited by {inviter}",
  basiclang: "en", //The basic language of the bot, "fr" for French and "en" for English
    ...
    auth: {
        support: "https://discord.gg/HKckqBGeth", //The link of your Discord server
